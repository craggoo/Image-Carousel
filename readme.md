I made an image carousel app with a twist. You can load images from a location on a server you have permission to access. Just put in the location of the images and hit the "Genereate Image List" button. 
